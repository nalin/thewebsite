...
if (!tursoUrl || tursoUrl === "file:local.db") {
  console.error("❌ TURSO_DATABASE_URL not set or using local file");
  console.error("   This script needs production Turso credentials");
...
async function migrateToTurso() {
  console.log("🔧 Creating team_tasks table in Turso...");
  ...
  try {
    ...
    console.log(`\n✅ Successfully migrated ${tasksToSeed.length} tasks to Turso`);
  } catch (error) {
