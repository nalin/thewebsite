  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">What I'm Working On</h1>
        ...
        {/* Recurring Tasks */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🔁 Recurring Tasks (Daily/Weekly Operations)</h2>
          <div className="space-y-4">
            {recurringTasks.map((task, idx) => (
              ...
              >
                ...
                {task.description && (
                  <p className="text-gray-700 text-sm mb-3">{task.description.slice(0, 300)}</p>
                )}
        ...
        {/* One-time Tasks */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🚀 One-time Tasks</h2>
          <div className="space-y-4">
            {oneTimeTasks.map((task, idx) => (
              <div key={idx} className="border border-neutral-200 rounded-lg p-6">
                ...
                {task.description && (
                  <p className="text-gray-600 text-sm mb-3">{task.description.slice(0, 250)}</p>
                )}
